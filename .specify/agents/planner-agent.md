...
- **Run Constitution Checks:** Run verification checks against `.specify/memory/constitution.md` and flag any violations.

## Execution Guidelines
1. Read the Project Constitution at `.specify/memory/constitution.md`.
2. Read the spec file at `.specify/specs/how2prompt-mvp/spec.md`.
3. Create the implementation plan at `.specify/specs/how2prompt-mvp/plan.md`.
